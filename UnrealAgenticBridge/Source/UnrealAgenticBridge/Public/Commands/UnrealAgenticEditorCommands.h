 ...
 */
class UNREALAGENTICBRIDGE_API FUnrealAgenticEditorCommands
{
public:
    	FUnrealAgenticEditorCommands();
...
private:
    ...
    TSharedPtr<FJsonObject> HandleSetActorColor(const TSharedPtr<FJsonObject>& Params);
