...
UENUM(BlueprintType)
enum class EUnrealAgenticBridgeProvider : uint8
{
...
class UNREALAGENTICBRIDGE_API UUnrealAgenticEditorSettings : public UDeveloperSettings
{
    GENERATED_BODY()
...
public:
    ...
    EUnrealAgenticBridgeProvider Provider;
