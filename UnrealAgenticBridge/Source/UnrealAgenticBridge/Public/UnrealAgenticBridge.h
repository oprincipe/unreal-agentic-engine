...
#include "UnrealAgenticBridge.generated.h"
 ...
 */
UCLASS()
class UNREALAGENTICBRIDGE_API UUnrealAgenticBridge : public UEditorSubsystem
{
	GENERATED_BODY()

public:
	UUnrealAgenticBridge();
	virtual ~UUnrealAgenticBridge();
