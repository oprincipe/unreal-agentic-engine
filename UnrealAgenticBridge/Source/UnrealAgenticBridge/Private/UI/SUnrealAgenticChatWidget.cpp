...
#define LOCTEXT_NAMESPACE "UnrealAgenticBridgeChat"
...
{
    return FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("UnrealAgenticBridge"), TEXT("ChatHistory.json"));
}
...
void SUnrealAgenticChatWidget::SaveMessageToHistory(const FChatMessage& Message)
{
    ...
    FString Dir = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("UnrealAgenticBridge"));
