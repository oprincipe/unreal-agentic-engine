...
// JSON Utilities
TSharedPtr<FJsonObject> FUnrealAgenticCommonUtils::CreateErrorResponse(const FString& Message)
{
...
TSharedPtr<FJsonObject> FUnrealAgenticCommonUtils::CreateSuccessResponse(const TSharedPtr<FJsonObject>& Data)
{
    TSharedPtr<FJsonObject> ResponseObject = MakeShared<FJsonObject>();
...
void FUnrealAgenticCommonUtils::GetIntArrayFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName, TArray<int32>& OutArray)
{
    OutArray.Reset();
...
void FUnrealAgenticCommonUtils::GetFloatArrayFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName, TArray<float>& OutArray)
{
    OutArray.Reset();
...
FVector2D FUnrealAgenticCommonUtils::GetVector2DFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName)
{
...
FVector FUnrealAgenticCommonUtils::GetVectorFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName)
{
...
FRotator FUnrealAgenticCommonUtils::GetRotatorFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName)
{
...
// Blueprint Utilities
UBlueprint* FUnrealAgenticCommonUtils::FindBlueprint(const FString& BlueprintName)
{
    return FindBlueprintByName(BlueprintName);
}

UBlueprint* FUnrealAgenticCommonUtils::FindBlueprintByName(const FString& BlueprintName)
{
    FString ObjectPath;
    FString PackagePath;
...
UEdGraph* FUnrealAgenticCommonUtils::FindOrCreateEventGraph(UBlueprint* Blueprint)
{
    if (!Blueprint)
    {
        return nullptr;
...
UK2Node_Event* FUnrealAgenticCommonUtils::CreateEventNode(UEdGraph* Graph, const FString& EventName, const FVector2D& Position)
{
    if (!Graph)
    {
        return nullptr;
...
UK2Node_CallFunction* FUnrealAgenticCommonUtils::CreateFunctionCallNode(UEdGraph* Graph, const UFunction* Function, const FVector2D& Position)
{
    if (!Graph || !Function)
    {
        return nullptr;
...
UK2Node_VariableGet* FUnrealAgenticCommonUtils::CreateVariableGetNode(UEdGraph* Graph, const UBlueprint* Blueprint, const FString& VariableName, const FVector2D& Position)
{
    if (!Graph || !Blueprint)
    {
        return nullptr;
...
UK2Node_VariableSet* FUnrealAgenticCommonUtils::CreateVariableSetNode(UEdGraph* Graph, const UBlueprint* Blueprint, const FString& VariableName, const FVector2D& Position)
{
    if (!Graph || !Blueprint)
    {
        return nullptr;
...
UK2Node_InputAction* FUnrealAgenticCommonUtils::CreateInputActionNode(UEdGraph* Graph, const FString& ActionName, const FVector2D& Position)
{
    if (!Graph)
    {
        return nullptr;
...
UK2Node_Self* FUnrealAgenticCommonUtils::CreateSelfReferenceNode(UEdGraph* Graph, const FVector2D& Position)
{
    if (!Graph)
    {
        return nullptr;
...
bool FUnrealAgenticCommonUtils::ConnectGraphNodes(const UEdGraph* Graph, UEdGraphNode* SourceNode, const FString& SourcePinName, 
...
UEdGraphPin* FUnrealAgenticCommonUtils::FindPin(UEdGraphNode* Node, const FString& PinName, EEdGraphPinDirection Direction)
{
    if (!Node)
    {
        return nullptr;
...
// Actor utilities
TSharedPtr<FJsonValue> FUnrealAgenticCommonUtils::ActorToJson(const AActor* Actor)
{
    if (!Actor)
    {
...
TSharedPtr<FJsonObject> FUnrealAgenticCommonUtils::ActorToJsonObject(const AActor* Actor, bool bDetailed)
{
    if (!Actor)
    {
        return nullptr;
...
UK2Node_Event* FUnrealAgenticCommonUtils::FindExistingEventNode(UEdGraph* Graph, const FString& EventName)
{
    if (!Graph)
    {
        return nullptr;
...
bool FUnrealAgenticCommonUtils::SetObjectProperty(UObject* Object, const FString& PropertyName, 
