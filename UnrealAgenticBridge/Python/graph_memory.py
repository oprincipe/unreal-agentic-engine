...
def _get_graph_path() -> str:
    ...
    #   e.g. C:\Users\...\AI_Mcp_Test\Saved\UnrealAgenticBridge\chat_history.db
    #   → we want C:\Users\...\AI_Mcp_Test\Saved\UnrealAgenticBridge\
    ...
    base = os.path.join(os.path.dirname(__file__), "..", "Saved", "UnrealAgenticBridge")
    os.makedirs(base, exist_ok=True)
    return os.path.join(base, "knowledge_graph.graphml")
