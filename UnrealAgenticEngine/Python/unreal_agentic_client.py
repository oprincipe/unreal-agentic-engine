...
Persistence:
  ...
  <UE Project>/Saved/UnrealAgenticEngine/chat_history.db
...
# ────────────────────────────────────────
LOG_FILE = os.path.join(tempfile.gettempdir(), "unreal_agentic_client.log")
...
log = logging.getLogger("UnrealAgenticEngineAgent")
...
def get_db_path() -> str:
    ...
    if env_path:
        return env_path
    saved_dir = os.path.join(os.path.dirname(__file__), "..", "Saved", "UnrealAgenticEngine")
