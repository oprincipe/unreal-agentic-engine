...
void SUnrealMCPChatWidget::OnInputTextCommitted(const FText& InText, ETextCommit::Type CommitMethod)
{
}

TSharedRef<SWidget> SUnrealMCPChatWidget::BuildChatBubble(const FChatMessage& Message)
{
    return SNew(SBorder)
