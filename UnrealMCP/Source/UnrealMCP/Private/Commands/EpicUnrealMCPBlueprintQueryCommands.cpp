...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleCommand(const FString& CommandType, const TSharedPtr<FJsonObject>& Params)
{
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleSearchBlueprintNodes(const TSharedPtr<FJsonObject>& Params)
{
    FString SearchTerm;
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadBlueprintFunctions(const TSharedPtr<FJsonObject>& Params)
{
    ...
    if (!Blueprint)
    {
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Failed to load Blueprint at path: %s"), *BlueprintName));
    }
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadBlueprintMacros(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'blueprint_path' parameter"));
    ...
    if (!BP)
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Failed to load Blueprint at: %s"), *BlueprintName));
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadBlueprintEnum(const TSharedPtr<FJsonObject>& Params)
{
    FString EnumPath;
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadBlueprintStruct(const TSharedPtr<FJsonObject>& Params)
{
    FString StructPath;
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadDataAsset(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath;
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadInputAction(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath;
    if (!Params->TryGetStringField(TEXT("asset_path"), AssetPath))
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'asset_path' parameter"));
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadInputMappingContext(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath;
    if (!Params->TryGetStringField(TEXT("asset_path"), AssetPath))
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'asset_path' parameter"));
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadWidgetVariables(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'blueprint_path' parameter"));
    ...
    if (!WidgetBP)
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Failed to load WidgetBlueprint at: %s"), *BlueprintName));
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadSaveGameBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'blueprint_path' parameter"));
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadMaterial(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath;
    if (!Params->TryGetStringField(TEXT("asset_path"), AssetPath))
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'asset_path' parameter"));
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadSoundClass(const TSharedPtr<FJsonObject>& Params)
{
    FString AssetPath;
    if (!Params->TryGetStringField(TEXT("asset_path"), AssetPath))
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Missing 'asset_path' parameter"));
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintQueryCommands::HandleReadBlueprintGraph(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    FString GraphName;
    ...
    if (!TargetGraph)
    {
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Graph '%s' not found in Blueprint: %s"), *GraphName, *BlueprintName));
    }
