...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleCommand(const FString& CommandType, const TSharedPtr<FJsonObject>& Params)
{
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleCreateBlueprint(const TSharedPtr<FJsonObject>& Params)
{
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleCompileBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleAddComponentToBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    {
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleAddBlueprintEventNode(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    {
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleAddBlueprintFunctionNode(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    {
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleAddBlueprintBranchNode(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    {
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleCreateBlueprintCustomEvent(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    {
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleConnectBlueprintNodes(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    {
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleCreateBlueprintVariable(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    {
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleDeleteBlueprintNode(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    FString NodeIdStr;
    ...
    {
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Invalid 'node_id' format. Must be a valid GUID."));
    }
    ...
    if (!NodeToDelete)
    {
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Node %s not found in Blueprint."), *NodeIdStr));
    }
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleBreakBlueprintLink(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    ...
    {
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Missing required parameters for break_blueprint_link."));
    }
    ...
    {
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Pin not found!"));
    }
...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintAuthoringCommands::HandleDeleteBlueprintComponent(const TSharedPtr<FJsonObject>& Params)
{
    FString BlueprintName;
    FString ComponentName;
    ...
    {
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Missing parameters for delete_blueprint_component."));
    }
    ...
    if (!NodeToRemove)
    {
        return FEpicUnrealMCPCommonUtils::CreateErrorResponse(TEXT("Component not found."));
    }
