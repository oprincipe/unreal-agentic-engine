...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('unreal_agentic_advanced.log'),
    ]
)
logger = logging.getLogger("UnrealAgenticBridge_Advanced")
...
async def server_lifespan(server: FastMCP) -> AsyncIterator[Dict[str, Any]]:
    ...
    global _unreal_connection
    logger.info("UnrealAgenticBridge Advanced server starting up")
    try:
