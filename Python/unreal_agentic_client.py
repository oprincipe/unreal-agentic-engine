...
Persistence:
  ...
  <UE Project>/Saved/UnrealAgenticBridge/chat_history.db
...
log = logging.getLogger("UnrealAgenticBridgeAgent")
...
def get_db_path() -> str:
    ...
    if env_path:
        return env_path
    saved_dir = os.path.join(os.path.dirname(__file__), "..", "Saved", "UnrealAgenticBridge")
